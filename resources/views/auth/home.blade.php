...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="auth-area">
                @auth
                    <a href="{{ route('profile.index') }}" style="color: #ffd700; text-decoration:none; font-weight:bold;">
    Halo, {{ auth()->user()->name }}
</a> |
 ...
 <form method="GET" style="margin: 20px 40px; padding:20px; 
    ...
    <div style="display:flex; gap:15px; flex-wrap:wrap;">
        ...
        <div class="produk-grid">
            @foreach($produk as $p)
            <a href="{{ route('produk.detail', $p->ProdukID) }}" style="text-decoration:none; color:inherit;">
